    ...
    >
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Catalog Builder"
          {...getOverrideProps(overrides, "Catalog Builder")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 321frd")}
      >
        <Button
          display="flex"
          gap="0"
          ...
          {...getOverrideProps(overrides, "Buttonjbd")}
        ></Button>
        <Button
          display="flex"
          gap="0"
          ...
          variation="primary"
          children="Add Video"
          {...getOverrideProps(overrides, "Buttonrtu")}
        ></Button>
      </Flex>
      <Flex
        gap="32px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 321omr")}
      >
        <SearchField
          display="flex"
          gap="8px"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          placeholder="Search Video or Category"
          size="default"
          isDisabled={false}
          labelHidden={true}
          variation="default"
